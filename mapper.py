...
def subscribe_coordinate_mapping_changed(kinect):
    """
    :param kinect: kinect class instance
    :return:
    """
...
def unsubscribe_coordinate_mapping_changed(kinect, waitableHandle_id):
    ...
    :param kinect: kinect class instance
    :param waitableHandle_id: integer representing the next process to be handled
    :return
    """
...
def get_coordinate_mapping_changed_event_data(kinect, waitableHandle_id):
    ...
    :param kinect: kinect class instance
    :param waitableHandle_id: integer representing the next process to be handled
    :return id with event to be handled
    """
...
def color_2_depth_space(kinect, color_space_point, depth_frame_data, show=False, return_aligned_image=False):
    """
    Map Color frame to Depth Space (Image)
    :param kinect: kinect class
...
def transform_color_2_depth(color_points, depth_points):
    ...
    :param color_points: list with 3 sets of color point pixel coordinates [[x, y], ..., [x, y]]
    :param depth_points: list with 3 sets of depth point pixel coordinates [[u, v], ..., [u, v]]
...
def xy2uv_with_res(x, y, color_width, color_height, depth_width, depth_height):
    ...
    :param x: integer x pixel coordinate
    :param y: integer y pixel coordinate
    :param color_width: integer color frame width
    :param color_height: integer color frame height
    :param depth_width: integer depth frame width
    :param depth_height: integer depth frame height
    :return list with integer pixel location
